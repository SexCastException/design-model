...
public class Proxy {
    public static Object newProxyInstance() throws Exception {
        ...
        Class<?> aClass = urlClassLoader.loadClass("com.huazai.gof.advanced.responsibility.proxy.one.LogTank$Proxy");
        System.out.println(aClass);

        System.out.println(Thread.currentThread().getContextClassLoader().loadClass("com.huazai.gof.advanced.responsibility.proxy.one.LogTank$Proxy"));
        System.out.println(Class.forName("com.huazai.gof.advanced.responsibility.proxy.one.LogTank$Proxy"));
